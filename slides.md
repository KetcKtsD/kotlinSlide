...
宣言時の型の省略で代入式の両辺に</br>型名を書く必要がなく
...
更にプライマリコンストラクタ渡されたパラメータは  
初期化ブロックでそのまま使用することができます。
...
更に更に！プライマリコンストラクタに渡された値を  
そのままクラスのプロパティとして持つことができます。
